...
#####################################
## species richness for burn sites ##
#####################################
...
#################################
## Abundance for control sites ##
#################################

sum(paper[ which(paper$Site==2013),]$HN) 

sum(paper[ which(paper$Site==2013),]$SB) 

########################################
## species richness for control sites ##
########################################

sum(paper[ which(paper$Site==2013),]$HN != 0)

sum(paper[ which(paper$Site==2013),]$SB != 0)

################################
## Abundance for 1-year sites ##
################################

sum(paper[ which(paper$Site==2014),]$CCW) 

sum(paper[ which(paper$Site==2014),]$WH) 

#######################################
## species richness for 1-year sites ##
#######################################

sum(paper[ which(paper$Site==2014),]$CCW != 0)
